...
BATCH_SIZE = 512        #how many records to use when doing one pass of gradient decent. Use a smaller number if your gpu is running out of memory.
...
MIN_DELTA = .0002             #early stop will want this much loss change before calling it improved.
